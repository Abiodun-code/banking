        ...
        <div className='article'>
            ...
            <div className='card'>
                <div className='card-bodys'>
                    <img src='/images/image-currency.jpg' alt="" className='card-image'/>
                ...
                <div className='card-bodys'>
                    <img src='/images/image-restaurant.jpg' alt="" className='card-image'/>
                ...
                <div className='card-bodys'>
                    <img src='/images/image-plane.jpg' alt="" className='card-image'/>
                    <p className='small'>By Wilson Hutton</p>
                ...
                <div className='card-bodys'>
                    <img src='/images/image-confetti.jpg' alt="" className='card-image'/>
                    <p className='small'>By Claire Robinson</p>
